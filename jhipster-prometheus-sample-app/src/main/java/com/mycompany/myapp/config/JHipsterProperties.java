...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "jhiprom@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "jhiprom API";

        private String description = "jhiprom API documentation";
